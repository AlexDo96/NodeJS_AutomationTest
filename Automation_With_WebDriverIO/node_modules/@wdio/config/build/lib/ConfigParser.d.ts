...
export default class ConfigParser {
     ...
     */
    getSpecs(capSpecs?: string[], capExclude?: string[]): (string | string[])[];
    /**
     ...
     */
    static getFilePaths(patterns: (string | string[])[], omitWarnings?: boolean, findAndGlob?: CurrentPathFinder & Globber & DeterminesAbsolutePath, hierarchyDepth?: number): (string | string[])[];
    /**
     ...
     */
    filterSpecs(specs: (string | string[])[], exclude: string[]): (string | string[])[];
}
export {};
